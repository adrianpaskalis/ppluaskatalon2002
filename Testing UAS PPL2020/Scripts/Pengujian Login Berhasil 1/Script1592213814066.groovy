...
WebUI.click(findTestObject('Object Repository/Page_Login/input_Login Akun_username'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Login/input_Login Akun_username'))
...
WebUI.verifyMatch(halaman_tujuan, 'https://testingjarkom.000webhostapp.com/admin/dashboard.php', false)
