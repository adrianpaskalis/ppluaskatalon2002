...
WebUI.setText(findTestObject('Page_Login/input_Login Akun_username'), 'user')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Login/span_Username  Password salah'), 'Username / Password salah')
