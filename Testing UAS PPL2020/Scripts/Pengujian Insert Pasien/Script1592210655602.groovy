...
WebUI.doubleClick(findTestObject('Page_Login/button_Login'))
...
WebUI.setText(findTestObject('Object Repository/Page_Sistem Antrian Disabilitas/input_Nama_name'), 'adrian')
...
WebUI.click(findTestObject('Object Repository/Page_Sistem Antrian Disabilitas/input_Nomor Telepon_phone_number'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Sistem Antrian Disabilitas/input_Nomor Telepon_phone_number'))

WebUI.setText(findTestObject('Object Repository/Page_Sistem Antrian Disabilitas/input_Nomor Telepon_phone_number'), '0858')
...
WebUI.executeJavaScript('arguments[0].value = \'1998-11-13\'', Arrays.asList(element))

WebUI.setText(findTestObject('Object Repository/Page_Sistem Antrian Disabilitas/textarea_Alamat_address'), 'jalan')
